...
if (isset($_POST['submit-search'])) {
    ...
    OR author_first_name LIKE '%{$search}%' 
    OR author_last_name LIKE '%{$search}%'
    OR CONCAT(author_first_name,' ',author_last_name) LIKE '%{$search}%'
    OR CONCAT(author_last_name,' ',author_first_name) LIKE '%{$search}%'
